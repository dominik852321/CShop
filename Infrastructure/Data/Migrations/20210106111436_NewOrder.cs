        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipToAddress_Email = table.Column<string>(type: "TEXT", nullable: true),
                    ShipToAddress_Phone = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductRoomId = table.Column<int>(type: "INTEGER", nullable: false),
                    Height = table.Column<int>(type: "INTEGER", nullable: false),
                    Width = table.Column<int>(type: "INTEGER", nullable: false),
                    Color1 = table.Column<string>(type: "TEXT", nullable: true),
                    Color2 = table.Column<string>(type: "TEXT", nullable: true),
                    Material1 = table.Column<string>(type: "TEXT", nullable: true),
                    Material2 = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemOrdered_Width = table.Column<int>(type: "INTEGER", nullable: true),
                    ItemOrdered_Height = table.Column<int>(type: "INTEGER", nullable: true),
                    Price = table.Column<double>(type: "decimal(18,2)", nullable: false),
