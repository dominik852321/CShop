(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('rxjs'), require('rxjs/operators'), require('detect-passive-events')) :
    typeof define === 'function' && define.amd ? define('@m0t0r/ngx-slider', ['exports', '@angular/core', '@angular/common', '@angular/forms', 'rxjs', 'rxjs/operators', 'detect-passive-events'], factory) :
    (global = global || self, factory((global.m0t0r = global.m0t0r || {}, global.m0t0r['ngx-slider'] = {}), global.ng.core, global.ng.common, global.ng.forms, global.rxjs, global.rxjs.operators, global.detectPassiveEvents));
}(this, (function (exports, core, common, forms, rxjs, operators, detectPassiveEvents) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    MathHelper = /** @class */ (function () {
         ...
         * @return {?}
         */
        MathHelper.roundToPrecisionLimit = /* Round numbers to a given number of significant digits */
        /**
         * @param {?} value
         * @param {?} precisionLimit
         * @return {?}
    ...
    var SliderComponent = /** @class */ (function () {
        ...
        SliderComponent.propDecorators = {
            ...
            leftOuterSelectionBarElement: [{ type: core.ViewChild, args: ['leftOuterSelectionBar', { read: SliderElementDirective, static: false },] }],
            rightOuterSelectionBarElement: [{ type: core.ViewChild, args: ['rightOuterSelectionBar', { read: SliderElementDirective, static: false },] }],
            fullBarElement: [{ type: core.ViewChild, args: ['fullBar', { read: SliderElementDirective, static: false },] }],
            selectionBarElement: [{ type: core.ViewChild, args: ['selectionBar', { read: SliderElementDirective, static: false },] }],
            minHandleElement: [{ type: core.ViewChild, args: ['minHandle', { read: SliderHandleDirective, static: false },] }],
            maxHandleElement: [{ type: core.ViewChild, args: ['maxHandle', { read: SliderHandleDirective, static: false },] }],
            floorLabelElement: [{ type: core.ViewChild, args: ['floorLabel', { read: SliderLabelDirective, static: false },] }],
            ceilLabelElement: [{ type: core.ViewChild, args: ['ceilLabel', { read: SliderLabelDirective, static: false },] }],
            minHandleLabelElement: [{ type: core.ViewChild, args: ['minHandleLabel', { read: SliderLabelDirective, static: false },] }],
            maxHandleLabelElement: [{ type: core.ViewChild, args: ['maxHandleLabel', { read: SliderLabelDirective, static: false },] }],
            combinedLabelElement: [{ type: core.ViewChild, args: ['combinedLabel', { read: SliderLabelDirective, static: false },] }],
            ticksElement: [{ type: core.ViewChild, args: ['ticksElement', { read: SliderElementDirective, static: false },] }],
    ...
    exports.Tick = Tick;
    exports.ɵa = SliderElementDirective;
    exports.ɵb = SliderHandleDirective;
    exports.ɵc = SliderLabelDirective;
    exports.ɵd = TooltipWrapperComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=m0t0r-ngx-slider.umd.js.map
