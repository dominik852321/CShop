import { Directive, ElementRef, Renderer2, HostBinding, forwardRef, EventEmitter, Component, ChangeDetectorRef, NgZone, Input, Output, ViewChild, ContentChild, HostListener, NgModule } from '@angular/core';
...
/**
 * @fileoverview added by tsickle
 * Generated from: lib/interfaces/pointer-type.ts
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
/** @enum {number} */
const PointerType = {
...
/**
 * @fileoverview added by tsickle
 * Generated from: lib/interfaces/change-context.ts
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class ChangeContext {
}
if (false) {
    /** @type {?} */
    ChangeContext.prototype.value;
    /** @type {?} */
    ChangeContext.prototype.highValue;
    /** @type {?} */
    ChangeContext.prototype.pointerType;
}
...
class ValueHelper {
    ...
    static findStepIndex(modelValue, stepsArray) {
        /** @type {?} */
        const differences = stepsArray.map((/**
         * @param {?} step
         * @return {?}
         */
        (step) => Math.abs(modelValue - step.value)));
        /** @type {?} */
...
/**
 * @fileoverview added by tsickle
 * Generated from: lib/helpers/compatibility-helper.ts
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
/**
...
/**
 * @fileoverview added by tsickle
 * Generated from: lib/helpers/math-helper.ts
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
/**
...
/**
 * @fileoverview added by tsickle
 * Generated from: lib/interfaces/event-listener.ts
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class EventListener {
    constructor() {
...
if (false) {
    /** @type {?} */
    EventListener.prototype.eventName;
    /** @type {?} */
    EventListener.prototype.events;
    /** @type {?} */
    EventListener.prototype.eventsSubscription;
    /** @type {?} */
    EventListener.prototype.teardownCallback;
}
...
SliderElementDirective.ɵfac = function SliderElementDirective_Factory(t) { return new (t || SliderElementDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SliderElementDirective, [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc0.Renderer2 }]; }, { opacity: [{
            type: HostBinding,
            args: ['style.opacity']
        }], visibility: [{
            type: HostBinding,
...
SliderHandleDirective.ɵfac = function SliderHandleDirective_Factory(t) { return new (t || SliderHandleDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SliderHandleDirective, [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc0.Renderer2 }]; }, { active: [{
            type: HostBinding,
...
SliderLabelDirective.ɵfac = function SliderLabelDirective_Factory(t) { return new (t || SliderLabelDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2)); };
...
class SliderComponent {
    ...
    subscribeInputModelChangeSubject(interval) {
         ...
         * @return {?}
         */
        (modelChange) => !modelChange.forceChange && !modelChange.internalChange)), (!ValueHelper.isNullOrUndefined(interval))
         ...
         * @return {?}
         */
        (modelChange) => this.applyInputModelChange(modelChange)));
    }
    /**
     * @private
     * @param {?=} interval
    ...
    subscribeOutputModelChangeSubject(interval) {
         ...
         * @return {?}
         */
        (modelChange) => this.publishOutputModelChange(modelChange)));
    }
    /**
     * @private
     * @return {?}
    ...
    updateTicksScale() {
        ...
        (value) => {
            ...
            if (!ValueHelper.isNullOrUndefined(this.viewOptions.getLegend)) {
                /** @type {?} */
                const legend = this.viewOptions.getLegend(value);
    ...
    getTicksArray() {
        ...
        /** @type {?} */
        const ticksArray = [];
        for (let value = this.viewOptions.floor; value <= this.viewOptions.ceil; value += step) {
    ...
    bindEvents() {
        ...
        if (!this.viewOptions.onlyBindHandles) {
             ...
             * @return {?}
             */
            (event) => this.onBarStart(null, draggableRange, event, true, true, true)));
        }
        if (this.viewOptions.draggableRangeOnly) {
             ...
             * @return {?}
             */
            (event) => this.onBarStart(PointerType.Min, draggableRange, event, true, true)));
            this.maxHandleElement.on('mousedown', (/**
             * @param {?} event
             * @return {?}
             */
            (event) => this.onBarStart(PointerType.Max, draggableRange, event, true, true)));
        }
        else {
            this.minHandleElement.on('mousedown', (/**
             * @param {?} event
             * @return {?}
             */
            (event) => this.onStart(PointerType.Min, event, true, true)));
            if (this.range) {
                this.maxHandleElement.on('mousedown', (/**
                 * @param {?} event
                 * @return {?}
                 */
                (event) => this.onStart(PointerType.Max, event, true, true)));
            }
            if (!this.viewOptions.onlyBindHandles) {
                 ...
                 * @return {?}
                 */
                (event) => this.onStart(null, event, true, true, true)));
                this.ticksElement.on('mousedown', (/**
                 * @param {?} event
                 * @return {?}
                 */
                (event) => this.onStart(null, event, true, true, true, true)));
            }
        }
        if (!this.viewOptions.onlyBindHandles) {
        ...
        if (this.viewOptions.draggableRangeOnly) {
            ...
            if (!this.viewOptions.onlyBindHandles) {
                 ...
                 * @return {?}
                 */
                (event) => this.onStart(null, event, false, false, true, true)));
            }
        }
        if (this.viewOptions.keyboardSupport) {
    ...
    onStart(pointerType, event, bindMove, bindEnd, simulateImmediateMove, simulateImmediateEnd) {
        ...
        if (bindMove) {
             ...
             * @return {?}
             */
            (e) => this.dragging.active ? this.onDragMove(e) : this.onMove(e));
    ...
    onPointerFocus(pointerType) {
         ...
         * @return {?}
         */
        (event) => this.onKeyboardEvent(event)));
...
SliderComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: SliderComponent, selectors: [["ngx-slider"]], contentQueries: function SliderComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
    ...
    } }, hostAttrs: [1, "ngx-slider"], hostVars: 5, hostBindings: function SliderComponent_HostBindings(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SliderComponent, [{
        ...
        args: [{
            ...
            type: ViewChild,
            args: ['leftOuterSelectionBar', { read: SliderElementDirective, static: false }]
        }], rightOuterSelectionBarElement: [{
            type: ViewChild,
            args: ['rightOuterSelectionBar', { read: SliderElementDirective, static: false }]
        }], fullBarElement: [{
            type: ViewChild,
...
/**
 * @fileoverview added by tsickle
 * Generated from: lib/slider/slider.module.ts
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
/**
 * NgxSlider module
...
/**
 * @fileoverview added by tsickle
 * Generated from: m0t0r-ngx-slider.ts
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */

export { ChangeContext, LabelType, NgxSliderModule, Options, PointerType, SliderComponent, Tick, SliderElementDirective as ɵa, SliderHandleDirective as ɵb, SliderLabelDirective as ɵc, TooltipWrapperComponent as ɵd };

//# sourceMappingURL=m0t0r-ngx-slider.js.map